...
const SERVICES = [
  ...
  { icon: Zap,        label: "Deploy to Sepolia",     desc: "One-click testnet deploy",        href: "/nuvari", color: "#f59e0b" },
];
      ...
      <div style={{ padding: "18px 18px 0" }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: "rgba(248,248,250,0.60)", margin: 0, lineHeight: 1.6 }}>
            Deploy, manage and earn yield on ERC-20 tokens on Sepolia / Hedera Testnet - no code needed. Choose a template, customise parameters, deploy in one click, and connect directly with KAI vaults and AMM pools.
          </p>
        </div>
